...
mt-3
      ...
      >
        {data?.map((el, i: number) => (
          ...
          ${
            value
              ? "absolute left-[7.5rem]  [&:nth-child(0)]:top-3 [&:nth-child(1)]:left-0   [&:nth-child(1)]:-top-0 [&:nth-child(2)]:left-60 [&:nth-child(2)]:-bottom-[46rem]   backtree rounded-md h-[100px] w-[100px] flex justify-center items-center"
